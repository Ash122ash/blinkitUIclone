import 'package:blinkit_replica/repository/screens/bottomnav/bottomnavscreen.dart';
import 'package:blinkit_replica/repository/widgets/uihelper.dart';
           ...
           Card(
             ...
             child: Container(
               ...
               child: Column(children: [
                 SizedBox(height: 10,),
                 UiHelper.CustomText(text: "Aayush", color: Color(0XFF000000), fontweight: FontWeight.w500 , fontsize: 14 ),
               SizedBox(height: 5,),
               UiHelper.CustomText(text: "9876543210", color: Color(0XFF9C9C9C), fontweight: FontWeight.bold , fontsize: 14,fontfamily: "bold" ),
               SizedBox(height: 15,),
               SizedBox(height: 45, width: 295,
               child: ElevatedButton(onPressed: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context) => BottomNavScreen()));
               },style: ElevatedButton.styleFrom( backgroundColor: Color(0XFFE23744),
    shape: RoundedRectangleBorder(
    borderRadius: BorderRadius.circular(10),
    )
    ),
